...
public class ItemImportDailServiceList extends ItemOperating {
	private static final String PROTOCOL = "0" + ";" + "importDailServicesList";
	private static final String MESSAGE = "Message ";

	private static final Logger LOGGER = LogManager
			.getLogger(ItemImportDailServiceList.class);

	public ItemImportDailServiceList(String name, IProcessing processing) {
