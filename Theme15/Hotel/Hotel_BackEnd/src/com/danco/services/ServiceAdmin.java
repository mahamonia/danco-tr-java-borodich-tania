...
public class ServiceAdmin implements IServiceAdmin {
	...
	public List<Room> getListRoom() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "", "id");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomSortedByContent() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "", "content");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomSortedByNumber() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "", "number");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomSortedByPrice() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "", "price");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomSortedByStars() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "", "stars");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomFree() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "FREE", "id");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomFreeSortedByContent() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "FREE", "content");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomFreeSortedByNumber() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "FREE", "number");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomFreeSortedByPrice() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "FREE", "price");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Room> getListRoomFreeSortedByStars() {
		...
		try {
			session.beginTransaction();
			list = contRoom.getListRoom(session, "FREE", "stars");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Service> getListService() {
		...
		try {
			session.beginTransaction();
			list = contService.getListService(session, "id");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Service> printServicesSortedByName() {
		...
		try {
			session.beginTransaction();
			list = contService.getListService(session, "name");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
	...
	public List<Service> printServicesSortedByPrice() {
		...
		try {
			session.beginTransaction();
			list = contService.getListService(session, "price");
			session.getTransaction().commit();
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		} finally {
