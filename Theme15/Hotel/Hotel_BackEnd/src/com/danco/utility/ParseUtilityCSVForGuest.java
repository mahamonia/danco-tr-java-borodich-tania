...
public class ParseUtilityCSVForGuest implements IParseUtilityCSVForGuest{
	...
	private CSVFileWorker fileGuest = new CSVFileWorker();
	@Injection
	...
	@Override
	public List<Guest> importData(String fileName) { // read from CSV

		String[][] tempGuest = fileGuest.readFromFile(fileName);
	...
	@Override
	public void exportData(List<Guest> guestsList, String fileName) { // write in CSV
		...
		fileGuest.writeToFile(strGuests, fileName);	
	}
