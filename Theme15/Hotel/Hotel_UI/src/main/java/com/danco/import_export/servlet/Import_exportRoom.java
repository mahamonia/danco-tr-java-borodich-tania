...
/**
 * Servlet implementation class Import_exportRoom
 */
public class Import_exportRoom extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private IServiceAdmin admin;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Import_exportRoom() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("import_export") != null) {
			...
			switch (item) {
			case "import":
				isPerformed = admin.importRoomsList(nameFile);
				break;
			case "export":
				isPerformed = admin.exportRoomsList(nameFile);
				break;
			}
	}
