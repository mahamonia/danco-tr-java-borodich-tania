...
<body>
	...
	<select onchange="location.href=this.value">
		...
		<option value="http://localhost:8080/Hotel_UI/import_exportGuest.jsp">Guest</option>
		<option value="http://localhost:8080/Hotel_UI/import_exportRoom.jsp">Room</option>
		<option value="http://localhost:8080/Hotel_UI/import_exportService.jsp">Service</option>
	</select>
</body>
</html>