...
<body>
	...
	<select onchange="location.href=this.value">
		...
		<option value="http://localhost:8080/Hotel_UI/viewGuest.jsp">Guest</option>
		<option value="http://localhost:8080/Hotel_UI/viewRoom.jsp">Room</option>
		<option value="http://localhost:8080/Hotel_UI/viewService.jsp">Service</option>
	</select>
</body>
</html>