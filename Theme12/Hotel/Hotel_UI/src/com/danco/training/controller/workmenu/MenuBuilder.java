...
import com.danco.training.controller.item.menuguest.ItemGetGuest;
import com.danco.training.controller.item.menuguest.ItemExportGuestsList;
import com.danco.training.controller.item.menuguest.ItemGetSumCheckGuest;
...
public class MenuBuilder {
	...
	private static final String Item_Get_Guest = "ItemGetGuest";
	...
	public Menu buildMenu() {
		...
		Item itemGetGuest = new ItemGetGuest(Item_Get_Guest, processing);
		...
		Item itemGetSumCheck = new ItemGetSumCheckGuest(ITEM_SUM_ORDER, processing);
		...
		itemsMenuGuest.add(itemGetGuest);
		...
		itemsMenuGuest.add(itemGetSumCheck);
