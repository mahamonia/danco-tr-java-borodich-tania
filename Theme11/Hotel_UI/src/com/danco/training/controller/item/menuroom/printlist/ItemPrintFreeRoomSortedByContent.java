...
public class ItemPrintFreeRoomSortedByContent extends ItemOperating {
	...
	private static final Logger LOGGER = LogManager
			.getLogger(ItemPrintFreeRoomSortedByContent.class);

	public ItemPrintFreeRoomSortedByContent(String name, IProcessing processing) {
