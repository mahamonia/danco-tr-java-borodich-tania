...
public class ControllerAdditionalService implements
	...
	private volatile AdditionalServiceDao additionalServiceDao;
	@Injection
	private IParseUtilityCSVForAdditionalService utility;

	public ControllerAdditionalService(AdditionalServiceDao additionalServiceDao) {
...
//		}
	...
	public void changeAdditionalPrice(int idService, int price) {
		...
		try {
			getService(idService).setAddPrice(price);
		} catch (Exception e) {
			logger.error(e.getMessage());
		}
	}
