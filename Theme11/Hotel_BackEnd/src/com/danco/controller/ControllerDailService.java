...
public class ControllerDailService implements IControllerDailService {
	...
	private volatile DailServiceDao dailServiceDao;
	@Injection
	private IParseUtilityCSVForDailService utility;

	public ControllerDailService(DailServiceDao dailServiceDao) {

		this.dailServiceDao = dailServiceDao;
...
//		}
	...
	public void changePrice(int idService, int price) {
		try {
			getService(idService).setPrice(price);
		} catch (Exception e) {
			logger.error(e.getMessage());
		}
	}
